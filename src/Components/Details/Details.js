            ...
            <div className="details-page">
                ...
                <div className="details-page-content">
                    ...
                    <div style={{ flex: 1, marginLeft: 30, display: "flex", flexDirection: "column" }}>
                        <div style={{ flex: 1 }}>
                            <div style={{ fontSize: 20, fontWeight: "bold", color: "#4282ad" }}>Giá: {this.state.item.price} $</div>
                            {this.state.item.inStock ?
                                <span style={{ color: "#0a7f19", marginTop: 5, fontSize: 14 }}> Còn hàng</span> :
                                <span style={{ color: "red", marginTop: 5, fontSize: 14 }}>Hết hàng</span>}
                        ...
                        <div style={{ fontWeight: "bold", fontSize: 16 }}>Mô tả:</div>
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                    <div className="online-shop-title-smaller">Sản phẩm liên quan {this.state.relatedItems.length === 0 ? "(N/A)" : ""}</div>
