                ...
                <div className="product-list-header">
                    ...
                    <div style={{ width: 500, marginTop: 5, display: "flex", flexGrow: 1, flexDirection: "row-reverse" }}>
                        ...
                        <div style={{ width: 250 }}>
                            <Dropdown
                                options={[
                                    { value: 'lh', label: 'Giá thấp đến cao' },
                                    { value: 'hl', label: 'Giá cao đến thấp' },
                                ]}
                        ...
                        {this.getParamFromURL("usePriceFilter") &&
                            <Tooltip title="Chọn khoản giá" disableFocusListener >
                                <Button
                                    variant="outlined"
                                    style={{ marginRight: 20, height: 33.2 }}
                                    onClick={() => {
